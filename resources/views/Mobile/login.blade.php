    ...
    <div class="page msg_success js_show">
        <div class="weui-msg">
            <div class="weui-msg__text-area">
                <h2 class="weui-msg__title">Login(登陸)</h2>
            </div>
            <div class="weui-msg__opr-area weui-article">
                ...
                <p>
                    <a href="{{url('/mobile/register')}}" class="login">新客戶，前往註冊</a>
                </p>
            </div>
    ...
    <script>
        ...
        $(".weui-btn_primary").click(function(event){
            ...
            if (csrftoken == '') {
                ...
                $.post("/api/login", { email: email, passwd: passwd , '_token':csrftoken},function(data){
                    if (data.status == 1) {
